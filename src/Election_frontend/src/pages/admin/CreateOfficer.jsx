...
const CreateOfficer = () => {
  ...
  return (
    <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4 bg-body text-body">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="row g-4 p-4 bg-body text-body rounded shadow-sm">
        {/* Election ID */}
        <div className="col-md-6">
          ...
          />
          {errors.electionId && <div className="invalid-feedback">{errors.electionId.message}</div>}
        </div>
        ...
        <div className="col-12">
          ...
          />
          {errors.officerName && <div className="invalid-feedback">{errors.officerName.message}</div>}
        </div>
        ...
        <div className="col-md-6">
          ...
          />
          {errors.pollingStation && <div className="invalid-feedback">{errors.pollingStation.message}</div>}
        </div>
        ...
        <div className="col-md-6">
          ...
          />
          {errors.pollingDivision && <div className="invalid-feedback">{errors.pollingDivision.message}</div>}
        </div>
